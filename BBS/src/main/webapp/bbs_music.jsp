	...
	<div class="container">
		<div class="row">
			<%
			    ...
			    ArrayList<Bbs_music> list = bbsDAO.getList(pageNumber);
			...
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
			    ...
			    <tbody>
			        <%
			            for (Bbs_music bbs : list) {
			        %>
			        <tr>
			            <td><%= rankNumber-- %></td> <!-- 게시글 번호 출력 -->
			            <td><a href="view_music.jsp?bbsID=<%= bbs.getBbsID() %>"><%= bbs.getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></a></td>
			            <td><%= bbs.getUserID() %></td>
		...
		<a href="write_music.jsp" class="btn btn-primary pull-right">글쓰기</a>
		</div>
	</div>
	<!-- FOOTER -->
