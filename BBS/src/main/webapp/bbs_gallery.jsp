...
<body>
	...
	<div class="container">
		...
		<%
			if(pageNumber != 1) {
		%>
			<a href="bbs_gallery.jsp?pageNumber=<%=pageNumber - 1%>" class="btn btn-success btn-arraw-left">이전</a>
		<%
			} if (bbsDAO.nextPage(pageNumber + 1)) {
		%>
			<a href="bbs_gallery.jsp?pageNumber=<%=pageNumber + 1%>" class="btn btn-success btn-arraw-left">다음</a>
		<%
			}
		%>
