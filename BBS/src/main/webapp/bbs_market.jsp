...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<tbody>
				<%
					...
					ArrayList<Bbs_market> list = bbsDAO.getList(pageNumber);
					for(int i=0; i<list.size(); i++) {
				%>
				<tr>
					<td><%= list.get(i).getBbsID() %></td>
					<td><a href="view_market.jsp?bbsID=<%= list.get(i).getBbsID() %>"><%= list.get(i).getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></a></td> 
		...
		<a href="write_market.jsp" class="btn btn-primary pull-right">글쓰기</a>
		</div>
	</div>
	<!-- FOOTER -->
